    ...
    <div className='footer-container'>
      ...
      <div className="footer-links">
        <div className="footer-link-wrapper">
          ...
          <div className="footer-link-items">
            <h2>Contact Us</h2>
            <Link to='/'>033324532</Link>
            <Link to='/'>hahaha@haha.org</Link>
      ...
      <section className="social-media">
        <div className="social-media-wrap">
          ...
          <div className="social-icons">
            ...
            <Link className="social-icon-link youtube" to='/' target='_blank' aria-aria-label='Youtube'>
              <i className="fab fa-youtube"></i>
            </Link>
            <Link className="social-icon-link linkedin" to='/' target='_blank' aria-aria-label='Linkedin'>
